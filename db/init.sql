...
-- 8. Inquiries (Support Tickets) Table
...
('Neural Link Headset Pro', 'Wearables', 620000.00, 30, '초저지연 뇌파 인터페이스 및 생체 신호 모니터링 기능이 내장된 프리미엄 스마트 헤드셋.', 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=600&auto=format&fit=crop', 'neural_headset_v2.pdf', FALSE, FALSE, 0),
('Hacker Mechanical Keyboard RGB', 'Accessories', 145000.00, 80, '핫스왑 커스텀 기계식 키보드. 프로그래밍 가능한 매크로 키 및 사이버펑크 RGB 백라이트 지원.', 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=600&auto=format&fit=crop', 'keyboard_firmware.pdf', FALSE, FALSE, 0),
('Zero-Trust Stealth Phone Z9', 'Smartphones', 1350000.00, 12, '하드웨어 킬스위치 및 분산 스토리지 아키텍처가 적용된 프라이버시 전용 플래그십 스마트폰.', 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&auto=format&fit=crop', 'stealth_phone_guide.pdf', FALSE, FALSE, 0),
('Tactical Cyber Drone Phantom', 'Drones', 890000.00, 22, '열화상 카메라 및 장거리 자동 비행 경로 지원. 자율 비행 메쉬 네트워크 기능 탑재.', 'https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=600&auto=format&fit=crop', 'drone_manual.pdf', FALSE, FALSE, 0),
('Titan Encrypted Cold Storage 2TB', 'Storage', 280000.00, 50, '군사 등급 AES-256 하드웨어 암호화 및 자폭 방지 센서가 내장된 알루미늄 외장 SSD.', 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=600&auto=format&fit=crop', 'titan_ssd_security.pdf', FALSE, FALSE, 0),
('HoloLens Augmented Glasses', 'Wearables', 780000.00, 18, '증강 현실 실시간 HUD 및 공간 인식 센서가 탑재된 차세대 스마트 안경.', 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&auto=format&fit=crop', 'hololens_quickstart.pdf', FALSE, FALSE, 0),
('DeepLearning Edge Server Box', 'Servers', 3400000.00, 5, '로컬 AI 추론을 위한 초소형 쿼드 GPU 엣지 서버. 실시간 영상 분석 및 네트워크 침입 탐지.', 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&auto=format&fit=crop', 'edge_server_admin.pdf', FALSE, FALSE, 0),
